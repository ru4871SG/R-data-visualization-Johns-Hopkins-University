...
```{r solution_p2, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r problem_3_data, warning=TRUE, include=FALSE}
...
```{r problem_4, echo=FALSE, warning=FALSE}
...
```{r problem_5_data, warning=FALSE, include=FALSE}
...
```{r problem_5, echo=FALSE, warning=FALSE}
...
```{r problem_6, echo=FALSE, warning=FALSE}
